  ...
  return (
    <Box>
      ...
      <Box p={16}>
        ...
        <Image
          margin={{ sm: "0", md: "auto", lg: "0" }}
          py={5}
          w="18%"
          src="https://animoto.com/static/wavy-e1cf461e1a9e7fed09a8a00a53c93f7f.svg"
        />
        <SimpleGrid columns={{ sm: 1, md: 1, lg: 2 }} spacing={16}>
          <Box>
            <SimpleGrid columns={{ sm: 1, md: 1, lg: 2 }} spacing={6}>
              <GridItem w="100%">
                <HStack>
                  <svg
      ...
      <Box >
        ...
        <SimpleGrid columns={{sm:1,md:1,lg:3}} px="6rem" py="4rem" spacingY={6}>
          <Box w="80%" align="center">
            ...
            <Text fontSize="1.2rem">
              Post to YouTube, Facebook, Twitter, and more with just one click,
              right from Animoto.
            </Text>
          </Box>
        ...
        <Box p={16}>
          ...
          <Accordion allowToggle>
            <SimpleGrid spacing={6} columns={{sm:1,md:1,lg:2}}>
              <Box>
                <AccordionItem>
                  <h2>
                    <AccordionButton>
                  ...
                  <AccordionPanel pb={4} fontSize="1.3rem">
                    ...
                    online video maker! Upload then drag and drop your images
                    into any of our video templates for a dynamic video
                    slideshow, complete with animations and licensed music.
                    Create a video from images in minutes!
                  </AccordionPanel>
                </AccordionItem>
              </Box>
              <Box>
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4} fontSize="1.3rem">
                    With Animoto, you can turn images to videos with music
                    online. All of our pre-built templates are set to high
                    quality music tracks, but you can easily customize your
                    video with any of our thousands of licensed music tracks.
                    Browse our collection and create a professional video in
                    minutes!
                  </AccordionPanel>
                </AccordionItem>
              </Box>
              <Box>
                <AccordionItem>
                  ...
                  <AccordionPanel pb={4} fontSize="1.3rem">
                    ...
                    your slideshow with licensed music tracks, your brand
                    colors, text, and more.
                  </AccordionPanel>
                </AccordionItem>
              </Box>
            </SimpleGrid>
